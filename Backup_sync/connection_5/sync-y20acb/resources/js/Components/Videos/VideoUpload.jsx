      ...
      {isSuccess && video ? (
        ...
        <div className="p-6 text-center space-y-6">
          ...
          <div className="space-y-2">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">Tải lên thành công!</h3>
          ...
          {!selectedFile ? (
            ...
            `}
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-600 rounded-full text-sm text-gray-600 dark:text-gray-300">
                ...
                <span>
                  Hỗ trợ: {SUPPORTED_VIDEO_FORMATS.map((f) => f.toUpperCase()).join(', ')}
                </span>
              </div>
            </div>
          ) : (
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                ...
                {!isGeneratingThumbnails && previewThumbnails.length === 0 && !thumbnail && (
                  <div className="space-y-3">
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Không thể tạo ảnh bìa tự động. Bạn có thể tải lên ảnh thủ công hoặc để hệ
                      thống tạo sau.
                    </p>
            ...
            <div className="relative overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 shadow-sm">
              ...
              <div className="absolute inset-0 opacity-[0.03] dark:opacity-[0.05]">
                <div
                  ...
                  style={{
                    background:
                      'radial-gradient(circle at 20% 50%, #6366f1 0%, transparent 50%), radial-gradient(circle at 80% 50%, #a855f7 0%, transparent 50%)',
                  }}
                />
              </div>
              ...
              <div className="relative">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-gray-700 dark:text-gray-200">
                      {uploadStatusDetail ||
                        (isProcessing ? 'Đang xử lý video...' : 'Đang tải lên...')}
                    </span>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="flex flex-col items-center p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-100 dark:border-gray-700">
                    <svg
                      className="w-4 h-4 text-primary-500 mb-1"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                  ...
                  <div className="flex flex-col items-center p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-100 dark:border-gray-700">
                    <svg
                      className="w-4 h-4 text-purple-500 mb-1"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                ...
                <div className="mt-3 flex items-center gap-2 text-[11px] text-gray-400 dark:text-gray-500">
                  <span
                    className={`inline-block w-2 h-2 rounded-full ${autoBandwidthState === 'stable' ? 'bg-emerald-400' : autoBandwidthState === 'recovering' ? 'bg-amber-400' : 'bg-red-400'} animate-pulse`}
                  />
