...
function normalizeContent(content: string, options: { ignoreWhitespace?: boolean; ignoreCase?: boolean } = {}) {
...
router.post('/:id', async (req: Request, res: Response) => {
    ...
    while (retryCount < 3) {
        ...
        try {
            ...
            let remoteContent = remoteBuffer.toString(remoteEncoding as BufferEncoding);
            ...
            if (await fs.pathExists(localPath)) {
                ...
                localContent = localBuffer.toString(localEncoding as BufferEncoding);
            }
